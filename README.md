...
This project is using Qwik with [QwikCity](https://qwik.dev/qwikcity/overview/). QwikCity is just an extra set of tools
on top of Qwik to make it easier to build a full site, including directory-based routing, layouts, and more.
...
- `src/routes`: Provides the directory-based routing, which can include a hierarchy of `layout.tsx` layout files, and
  ...
  the [routing docs](https://qwik.dev/qwikcity/routing/overview/) for more info.
...
the [Static Site Generator (SSG)](https://qwik.dev/qwikcity/guides/static-site-generation/).
